...
namespace BankAppApi.Controllers
{
    ...
    [ApiController]
    public class AccountApplicationController : ControllerBase
    {
        private readonly IAccountApplicationRepository _accountAppRepository;
        private readonly BankContext _context;
        private readonly IMapper _mapper;
        public AccountApplicationController(BankContext context, IMapper mapper, IAccountApplicationRepository accountAppRepository)
        {
        ...
        public IActionResult PostApplication([FromBody] AccountApplicationDto accountApplicationDto)
        {
            ...
            {
                ModelState.AddModelError("", "Hesap Oluşturulamadı");
        ...
        public IActionResult UpdateAccountApplication(int accountappId, [FromBody] AccountApplicationDto updatedAccountApplicationDto)
        {
            ...
            {
                ModelState.AddModelError("", "Hesap Güncellemesi Başarısız");
                return StatusCode(500, ModelState);
            }
